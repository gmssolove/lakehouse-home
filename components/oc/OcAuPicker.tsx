...
export function OcAuPicker({ character, auIdx, onAuChange }: Props) {
  ...
  return (
    <div className="oc-au-picker" role="toolbar" aria-label="AU 버전">
      <button
        type="button"
      ...
      >
        {defaultSrc ? (
          ...
          <span className="oc-au-picker-fallback">D</span>
        )}
      </button>
      {versions.map((au, i) => {
