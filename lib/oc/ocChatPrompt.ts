...
function staticRulesBlock(): string[] {
  return [
    ...
    '- 최신(마지막) 유저 말이 질문·요청·되묻기면 그 내용은 반드시 messages에 반영한다. 앞선 말(쉴게요·고마워·맞장구)만 받고 질문을 飛ば는 것은 금지.',
    '- 나쁜 예: 유저가 "이제 쉴려구요" + "뭐 하고 있었어요?"인데 "푹 쉬어/내일 또"만 하고 현황 질문에 아무 말도 없음.',
    '- 좋은 예: 짧은 휴식 반응 + 본인 현황을 한 줄로(예: "응 쉬어. 난 그냥 폰 보고 있었어."). 말풍선 1~2개로 합쳐도 된다.',
